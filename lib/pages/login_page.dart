...
import 'register_page.dart'; // Import untuk navigasi ke Register
...
class _LoginPageState extends State<LoginPage> {
  ...
  // --- PERUBAHAN DI SINI: Default value dihapus ---
  ...
  Future<void> _handleLogin() async {
    ...
    try {
      ...
      if (res.session != null) {
        if (!mounted) return;
        // Navigasi ke Halaman Produk setelah sukses login
        ...
        setState(() {
          _error = 'Gagal login. Periksa email dan password.';
        });
      }
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  // Hint text dipertahankan, field kosong
